 ...
 * the implications!
 */
#define USB_CFG_DEVICE_ID 0x1a, 0x30
 ...
 */
#define USB_CFG_VENDOR_NAME     'P','i','x','A','r','t'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'D','e','l','l',' ','M','S','1','1','6',' ','U','S','B',' ','O','p','t','i','c','a','l',' ','M','o','u','s','e'
#define USB_CFG_DEVICE_NAME_LEN 28
/* Same as above for the device name. If you don't want a device name, undefine
 * the macros. See the file USB-IDs-for-free.txt before you assign a name if
 * you use a shared VID/PID.
 */
#define USB_CFG_SERIAL_NUMBER   '3','0','6','2','4','7','0','0'
